...
The [appveyor-tools.ps1](scripts/appveyor-tools.ps1) powershell can be used for unattended installation of these tools.
...
Now either download [R-devel.tar.gz](https://stat.ethz.ch/R/daily/R-devel.tar.gz) or [R-patched.tar.gz](https://stat.ethz.ch/R/daily/R-patched.tar.gz) from the R website into this directory. Running `r-devel.bat` or `r-patched.bat` will start the build. The [appveyor.yml] file has more details.
